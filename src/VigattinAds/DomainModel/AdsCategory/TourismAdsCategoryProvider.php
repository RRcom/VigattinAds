...
class TourismAdsCategoryProvider extends GenericAdsCategoryProvider
{
    protected $categories = array(
        ...
        array('keyword' => '(destination)',     'title' => 'Destination',   'previewLink' => 'http://vigattintourism.com/tourism/destinations#preview', 'group' => '', 'disable' => false),
        ...
        array('keyword' => '(destinations)',    'title' => 'Destinations',  'previewLink' => 'http://vigattintourism.com/tourism/destinations/91/directory#preview', 'group' => '', 'disable' => false),
    );
}